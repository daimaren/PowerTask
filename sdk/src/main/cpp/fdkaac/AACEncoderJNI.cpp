#include "com_mlingdu_sdk_fdkaac_AACEncoder.h"
...
extern "C"
JNIEXPORT jint JNICALL Java_com_mlingdu_sdk_fdkaac_AACEncoder_encode(JNIEnv * env, jobject obj, jstring pcmFilePathParam, jstring aacFilePathParam){
...
JNIEXPORT jint JNICALL Java_com_mlingdu_sdk_fdkaac_AACEncoder_encodeAndDecodeTest(JNIEnv * env, jobject obj, jstring pcmFilePathParam, jstring aacFilePathParam){
    const char* pcmFilePath = env->GetStringUTFChars(pcmFilePathParam, NULL);
    const char* aacFilePath = env->GetStringUTFChars(aacFilePathParam, NULL);
    LOGI("pcmFilePath is %s", pcmFilePath);
    LOGI("aacFilePath is %s", aacFilePath);
