...
void CainMediaPlayer_prepareSave(JNIEnv *env, jobject thiz) {
    CainMediaPlayer *mp = getMediaPlayer(env, thiz);
    if (mp == NULL) {
        jniThrowException(env, "java/lang/IllegalStateException");
        return;
...
void CainMediaPlayer_prepareSaveAsync(JNIEnv *env, jobject thiz) {
    CainMediaPlayer *mp = getMediaPlayer(env, thiz);
    if (mp == NULL) {
        jniThrowException(env, "java/lang/IllegalStateException");
        return;
...
void CainMediaPlayer_startSave(JNIEnv *env, jobject thiz) {
    CainMediaPlayer *mp = getMediaPlayer(env, thiz);
    if (mp == NULL) {
        jniThrowException(env, "java/lang/IllegalStateException");
        return;
...
static const JNINativeMethod gMethods[] = {
        ...
        //视频保存
        {"_prepareSave", "()V", (void *) CainMediaPlayer_prepareSave},
        {"_prepareSaveAsync", "()V", (void *) CainMediaPlayer_prepareSaveAsync},
        {"_startSave", "()V", (void *) CainMediaPlayer_startSave}
};
