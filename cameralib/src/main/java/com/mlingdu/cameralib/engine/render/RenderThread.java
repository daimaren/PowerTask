...
import com.mlingdu.cameralib.engine.camera.CameraEngine;
import com.mlingdu.cameralib.engine.camera.CameraParam;
import com.mlingdu.cameralib.engine.recorder.HardcodeEncoder;
    ...
    void drawFrame() {
        ...
        if (isRecording && !isRecordingPause) {
            ...
            HardcodeEncoder.getInstance()
                    .drawRecorderFrame(mInputTexture, mSurfaceTexture.getTimestamp());
        }
    }
